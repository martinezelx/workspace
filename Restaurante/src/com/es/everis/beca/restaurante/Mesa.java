...
public class Mesa {
	...
	public Mesa (int liberarmesa) {
		this.idMesa = liberarmesa;
		
	}
	
	//public Mesa(Persona[] clientes) {
		//super();
		//this.idMesa = ++contador; 
	...
	public String toString() {
		return "Mesa [idMesa=" + idMesa +", camarero=" + camarero + ", pedido=" + pedido + ", clientes=" + Arrays.toString(clientes) + "]";
	}
